$(document).ready( function () {
    ...
    department.Get().then(function(res){
        ...
        $('#table_filter').append('<b><button class="btn btn-sm btn-outline-secondary add" onclick="department.new();" style="margin-left: 20px;margin-top:-4px;"><i class="fas fa-folder"></i> New</button></b>');    
