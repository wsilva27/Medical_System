$(document).ready( function () {
    ...
    doctor.Get().then(function(res){
        ...
        $('#table_filter').append('<b><button class="btn btn-sm btn-outline-secondary add" onclick="doctor.new();" style="margin-left: 20px;margin-top:-4px;"><i class="fas fa-user-md"></i> New</button></b>');
...
var doctor = new function(){
    ...
    this.Get = function () {
        return $.ajax({
                    method: 'POST',
                    dataType: 'json',
                    url: base_URL + 'api/get.doctor.php',
