$(document).ready( function () {
    ...
    specialty.Get().then(function(res){
        ...
        $('#table_filter').append('<b><button class="btn btn-sm btn-outline-secondary add" onclick="specialty.new();" style="margin-left: 20px;margin-top:-4px;"><i class="fas fa-briefcase-medical"></i> New</button></b>');        
...
var specialty = new function(){
    ...
    this.Get = function () {
        return $.ajax({
                    method: 'POST',
                    dataType: 'json',
                    url: base_URL + 'api/get.specialty.php',
